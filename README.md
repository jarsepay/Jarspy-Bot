This bot is still using QR Scanning to connect to the bot. Please provide 2 handphones to connect it. We will trying to change it with a pairing code, so you can connect it easily, along with the Jadibot feature. See more information about Jarspy from our [whatsapp group here](https://chat.whatsapp.com/KieFrG8MEt7C99IJKYS8qE)
