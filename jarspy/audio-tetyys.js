...
const [atas, bawah, kiri, kanan] = text.split("|"); 
 ...
 await m.reply("Voice: " + lister[atas - 1] + "\n" + "Mohon Tunggu Sebentar...") 
  try { 
...
async function SayTTS(voice, text, pitch, speed) { 
    try { 
        ...
        if (text.length > 4088) { 
            throw new Error("Teks melebihi panjang maksimum yang diperbolehkan (1000 karakter)"); 
        } 
