...
let jarspy = async (m, { command, text, usedPrefix }) => { 
    ...
    var lower = arr.map(v => v.toLowerCase())
  
    if (!lower.includes(text.toLowerCase())) throw "Kode negara tidak valid. Silakan masukkan kode negara yang valid." + "\n\n" + mess
