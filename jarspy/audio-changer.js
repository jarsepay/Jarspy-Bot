...
let jarspy = async (m, { conn, args, __dirname, usedPrefix, command }) => {
	try {
...
jarspy.help = ['bass','blown','deep','earrape','fast','fat','nightcore','reverse','robot','slow','smooth','tupai']
jarspy.tags = ['audio']
jarspy.command = /^(bass|blown|deep|earrape|fas?t|nightcore|reverse|robot|slow|smooth|tupai|squirrel|chipmunk)$/i
