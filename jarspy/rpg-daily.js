...
let cooldown = isPrems => isPrems ? 2160000 : 86400000;
...
let jarspy = async (m, { isPrems }) => {
  ...
  if (new Date - user.lastdaily < cooldown) throw `Kamu sudah mengambil hadiah harian ini. Tunggu selama *${((user.lastdaily + cooldown) - new Date()).toTimeString()}*`
